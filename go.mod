...
require (
	...
	github.com/hemilabs/heminetwork v1.2.0
...
replace github.com/ethereum/go-ethereum => github.com/hemilabs/op-geth v1.101308.0-synctest.0.0.20250519183324-ff3c59cd40e9
