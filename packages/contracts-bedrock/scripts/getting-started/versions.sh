...
versionFoundry() {
  ...
  local timestamp_regex='([0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{9}Z)\)'
  local full_regex="${version_regex} ${commit_hash_regex} ${timestamp_regex}"
...
echo "foundry      0.2.0 (a5efe4f 2024-02-08T00:16:00.244105000Z)  $ver_foundry"
