...
func NewL2Sequencer(t Testing, log log.Logger, l1 derive.L1Fetcher, eng L2API, cfg *rollup.Config, seqConfDepth uint64, bssClient client.BssClient) *L2Sequencer {
	ver := NewL2Verifier(t, log, l1, eng, cfg, &sync.Config{}, bssClient)
	...
	return &L2Sequencer{
		L2Verifier:              *ver,
		sequencer:               driver.NewSequencer(log, cfg, ver.derivation, attrBuilder, l1OriginSelector, metrics.NoopMetrics, eng, bssClient),
