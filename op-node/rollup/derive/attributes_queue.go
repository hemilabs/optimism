...
func (aq *AttributesQueue) createNextAttributes(ctx context.Context, batch *SingularBatch, l2SafeHead eth.L2BlockRef) (*eth.PayloadAttributes, error) {
	...
	aq.log.Info("new epoch?", "newEpoch", newEpoch, "origin", l2SafeHead.L1Origin.Number, "epoch", batch.Epoch().Number)
	...
	aq.log.Info("blah", "parent", l2SafeHead, "prepared prevrandao", attrs.PrevRandao)
