...
func newRPCServer(rpcCfg *RPCConfig, rollupCfg *rollup.Config, l2Client l2EthClient, dr driverClient,
	safeDB SafeDBReader, log log.Logger, metrics opmetrics.RPCMetricer, appVersion, bfgURL string) *oprpc.Server {
	...
	api := NewNodeAPI(rollupCfg, l2Client, dr, safeDB, log, metrics, bfgURL)
